...
const CONTACTS = {
  ...
  // PENTING: Kita pisah email address murni dan link web
  emailAddress: "reinachamhada@gmail.com", 
  emailWebLink: "https://mail.google.com/mail/?view=cm&fs=1&to=reinachamhada@gmail.com",
  nsfwForm: "https://docs.google.com/forms/d/e/1FAIpQLSdcKmVL7SysZYvoT0B57CuC3Xzj8k6MBcInrMWJgre0JLu1jg/viewform"
};
...
export default function CommissionWidget() {
  ...
  // Kalau Mobile -> pakai 'mailto:' (Buka App)
  // Kalau Desktop -> pakai Link Web Gmail (Buka Tab Baru)
  const emailHref = isMobile 
    ? `mailto:${CONTACTS.emailAddress}` 
    : CONTACTS.emailWebLink;
        ...
        {showModal && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
            ...
            <motion.div 
              ...
              className="relative bg-white p-8 rounded-3xl max-w-lg w-full shadow-2xl overflow-hidden"
            >
              ...
              {/* BAGIAN 1: GRID MEDSOS (VGEN & SOSMED DI ATAS) */}
              <div className="grid grid-cols-2 gap-3 mb-6">
                 ...
                 <a 
                   ...
                   target="_blank" 
                   rel="noreferrer" 
                   className="p-3 bg-zinc-5 hover:bg-[#B8FF26] hover:text-deep-purple rounded-xl border border-zinc-200 hover:border-[#B8FF26] transition-all flex flex-col items-center gap-2 group"
                 >
                    ...
                    <span className="text-xs font-bold text-black group-hover:text-deep-purple transition-colors">VGen</span>
                 </a>
                 ...
                 <a 
                   ...
                   target="_blank" 
                   rel="noreferrer" 
                   className="col-span-2 p-3 bg-zinc-5 hover:bg-accent-red hover:text-white rounded-xl border border-zinc-200 hover:border-accent-red transition-all flex items-center justify-center gap-3 group"
                 >
              ...
              <div className="mb-2">
                 <a href={CONTACTS.nsfwForm} target="_blank" rel="noreferrer" className="w-full flex items-center gap-4 p-4 rounded-xl bg-accent-red/5 border border-accent-red hover:bg-accent-red hover:text-white transition-all group">
                    <div className="w-10 h-10 rounded-full bg-accent-red text-white group-hover:bg-white group-hover:text-accent-red flex items-center justify-center shrink-0 font-bold text-xl">!</div>
                    <div>
              ...
              <button onClick={() => setShowModal(false)} className="mt-6 text-sm text-zinc-400 hover:text-deep-purple underline w-full transition-colors">Cancel</button>
            </motion.div>
          </div>
        )}
      </AnimatePresence>
