    ...
    <main className="min-h-screen bg-white text-deep-purple relative font-sans">
      ...
      >
        ...
        <motion.div variants={fadeInUp} className="relative w-48 h-48 mx-auto mb-2">
           <Image 
             src="/reina-sit.png" // Pastikan nama file ini sesuai di folder public
             alt="Reina Sit" 
             fill 
        ...
        <motion.div variants={fadeInUp} className="space-y-4">
          ...
          {/* EMAIL */}
          <a href="https://mail.google.com/mail/?view=cm&fs=1&to=reinachamhada@gmail.com" target="_blank" className="w-full flex items-center justify-center gap-3 py-4 rounded-xl bg-zinc-100 text-deep-purple font-bold border border-zinc-200 hover:bg-zinc-200 hover:shadow-lg hover:-translate-y-1 transition-all">
